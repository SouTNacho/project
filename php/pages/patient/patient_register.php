...
<body>
    <main>
        <form action="actions/patient_register.php" method="post" id="patient_register_form">
            ...
            <div>
                <input type="submit" value="REGISTRAR" id="patient_register_btn">
                <span id="patient_register_btn_msg"></span>
            </div>
        </form>
    </main>
    <script type="module" src="/js/register_patient.js"></script>
</body>
</html>