...
<head>
    ...
    <title>BYP - Personas trasladadas por Ambulancia</title>
...
<body id="top">
    ...
    <nav class="navbar flex-center-column" aria-label="Navegación principal">
        <ul class="navbar_list">
            ...
            <li class="navbar_list_item">
                <a href="/php/pages/patient/patient_register.php">Registrar pacientes</a>
            </li>
            <li class="navbar_list_item">
                <a href="/php/pages/patient/patient_update.php">Act. Paciente</a>
            </li>
            <li class="navbar_list_item">
                <a href="/php/pages/patient/manage_patients.php">Admin. Pacientes</a>
            </li>
            <li class="navbar_list_item">
    ...
    <main class="main flex-center-column">
        <h1>Panel de Personas trasladadas</h1>
        <section class="main_section">
            <div class="main_content">
                <h2>Panel de Personas trasladadas</h2>
