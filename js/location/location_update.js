let nombre_ubicacion_update =
    document.getElementById("nombre_ubicacion_update");

let nombre_nuevo =
    document.getElementById("nombre_nuevo");

let direccion_update =
    document.getElementById("direccion_update");

let departamento_update =
    document.getElementById("departamento_update");

let localidad_update =
    document.getElementById("localidad_update");

let descripcion_update =
    document.getElementById("descripcion_update");

let boton_update =
    document.getElementById("boton_update_ubicacion");
...
boton_update.addEventListener("click", async (e) => {
    ...
    nombre_ubicacion_update.value =
        nombre_ubicacion_update.value.trim();

    nombre_nuevo.value =
        nombre_nuevo.value.trim();

    direccion_update.value =
        direccion_update.value.trim();

    departamento_update.value =
        departamento_update.value.trim();

    localidad_update.value =
        localidad_update.value.trim();

    descripcion_update.value =
        descripcion_update.value.trim();
